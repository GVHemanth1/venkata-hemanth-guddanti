...
const Insights: React.FC = () => {
  ...
  const contentPosts: ContentPost[] = [
    ...
    },
    {
      ...
      type: 'article',
      title: 'Modernizing Middleware ACE/IIB Development with Cloud-Based Ingrations',
      description: 'Part 2 of 3: The Magic of Secure Tunneling and Remote Admin',
      content: 'we use the GitHub CLI to create a bridge. This allows your local ACE 12 Toolkit to talk to the ACE v13 Cloud Server over an encrypted HTTPS connection.',
      date: new Date('2026-02-26'),
      tags: ['ACE Integration', 'DevOps integration', 'Architecture designing', 'Best Practices'],
      readTime: 7,
      link: 'https://medium.com/@venkatahemanth/turning-github-codespaces-into-a-secure-production-grade-ibm-ace-environment-c658150580c8',
      featured: true,
      icon: '🔮',
    },
    {
