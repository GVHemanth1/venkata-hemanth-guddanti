      ...
      <div className="max-w-6xl mx-auto">
        <FadeInSection>
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-16 text-center">
            Professional <span className="text-ibm-blue dark:text-neon-cyan">Journey</span>
          </h2>
        </FadeInSection>

        <div className="relative">
          {/* Desktop Center Line */}
          <div className="hidden md:block absolute left-[25%] top-0 bottom-0 w-px bg-slate-300 dark:bg-slate-700" />
          {/* Mobile Left Line */}
          <div className="md:hidden absolute left-5 top-0 bottom-0 w-px bg-slate-300 dark:bg-slate-700" />
                ...
                <div className="relative grid md:grid-cols-[25%_auto_1fr] gap-0 md:gap-8 items-start group">
                  ...
                  <div className="absolute left-5 md:static md:flex md:justify-center pt-9 z-10">
                    ...
                    <div className="relative flex items-center justify-center">
                      <div className="w-3 h-3 md:w-4 md:h-4 rounded-full bg-ibm-blue dark:bg-neon-cyan border-2 md:border-4 border-slate-100 dark:border-slate-900 shadow-lg group-hover:scale-125 transition-transform duration-300" />
                      {/* Pulse effect */}
                      <div className="absolute w-6 h-6 md:w-8 md:h-8 rounded-full bg-ibm-blue/20 dark:bg-neon-cyan/20 animate-ping opacity-0 group-hover:opacity-75 transition-opacity" />
                    </div>
                  </div>
